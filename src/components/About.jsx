    ...
    <section id="about" className="py-16 bg-white flex justify-center items-center">
      <div className="max-w-6xl px-6 md:px-12 lg:px-20 text-center md:text-left">
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          I'm a self-taught <span className="font-semibold">Front-End Developer</span> with <span className="font-semibold">1.5 years</span> of coding experience. I started with front-end technologies and I am currently learning back-end development to expand my skill set.
        </p>

        {/* Skills */}
        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-800">Tech Stack</h3>
          <p className="text-gray-700 mt-2">HTML, CSS, JavaScript, React, Tailwind, Bootstrap</p>
        </div>
